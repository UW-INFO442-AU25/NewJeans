    ...
    <div className="company-card-employer" onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
      ...
      <div className="company-card-details">
        <div className="company-card-detail-item">
          <div className="company-card-icon-button">
            <svg className="company-card-location-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="company-card-detail-text">{employer.location}</div>
        </div>

        <div className="company-card-detail-item">
          <div className="company-card-icon-button">
            <svg className="company-card-briefcase-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="company-card-detail-text">{employer.openPositions} open position{employer.openPositions !== 1 ? 's' : ''}</div>
        </div>
      </div>

      <div className="company-card-visa-section">
        <div className="company-card-visa-label">Offered Visas</div>
        <div className="company-card-visa-badges">
          {employer.visaTypes.map((visa) => (
            <div key={visa} className="company-card-visa-badge">
              {visa}
            </div>
          ))}
        </div>
